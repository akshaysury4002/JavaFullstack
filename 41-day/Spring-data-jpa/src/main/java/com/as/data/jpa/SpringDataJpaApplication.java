...
import com.as.data.jpa.domain.Mobile;
import com.as.data.jpa.domain.Product;
import com.as.data.jpa.repo.ProductRepository;
import com.as.data.jpa.repo.ProductSpecifications;
import com.as.data.jpa.repo.SimpleJpaRepo;
import com.as.data.jpa.service.ProductService;
...
public class SpringDataJpaApplication {
	...
	public static void main(String[] args) {
		...
		demo7(ctx.getBean(ProductRepository.class));
