...
public class BasicDemo {
    ...
    public void demo10()
    {
    	...
    	List<Integer> numbers=new ArrayList<>(Arrays.asList(arr1));
    	List<Integer> numbers2=new ArrayList<>(Arrays.asList(arr2));
